  ...
  return (
    <div className="m-5" >
        ...
        <div className="d-flex flex-row justify-content-left p-2">
            ...
            <input type="text" class="form-control w-25 ml-2" id="inputPassword" value="Generación1"/>
           
        </div>
        <div className="d-flex flex-row justify-content-left  p-2">
        <label className="col-form-label fs-6">Fecha de inicio:</label>
        <input type="date" className="ml-2" value="2021-01-15"/>
           
        </div>
        <div className="d-flex flex-row justify-content-left p-2">
            <label className="col-form-label fs-6">Fecha de fin:</label>
            <input type="date" className="ml-2" value="2021-05-15"/>
...
export default EditarGeneracion;