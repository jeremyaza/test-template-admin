...
const Entrevistas = React.lazy(() =>
  import("./modules/Entrevistas/Entrevistas")
);
...
const NoAdmitidos = React.lazy(() =>
  import("./modules/No_admitidos/NoAdmitidos")
);
const Generaciones = React.lazy(() =>
  import("./modules/Generaciones/Generaciones")
);
